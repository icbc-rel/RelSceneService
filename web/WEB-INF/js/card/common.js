...
if($(".content").length>0){
	$(".content").prepend('<div class="title">'
			...
			+'<li class="title_listb"><div style="cursor:pointer;"><span class="iid" style="display:none">mapper.card</span><img class="y1" src="../../image/com/a3.png" width="30" height="30"onclick="" /><span class="y2" style="color:#ffffff">贺卡推送</span></div><div class="clear"></div></li>'
